...
const LendBooksScreen = ({ navigation }) => {
  console.log('LendBooksScreen rendered');
  ...
  const submitForm = () => {
    Alert.alert('Submitted', 'Your book has been listed for lending!');
  };
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.catchphrase}>Lend your books to us now!</Text>
      </View>
...
export default LendBooksScreen;
